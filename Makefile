CC=			gcc
CFLAGS=		-g -Wall -O2 -Wno-unused-variable -Wno-unused-but-set-variable -Wno-unused-function
OBJS=		main.o build_ref.o bntseq.o lsat_heap.o lsat_aln.o lsat_dp_con.o frag_check.o split_mapping.o extend_ssw.o ssw.o ksw.o \
